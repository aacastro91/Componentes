function adate_enable_field(form_name, field) {
...
function adate_disable_field(form_name, field) {
...
function adate_start( id, mask, language) {
    $( id ).wrap( '<div class="tdate-group date input-group">' );
    $( id ).after( '<span class="btn btn-default tdate-group-addon input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>' );
